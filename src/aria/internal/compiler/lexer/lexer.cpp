...
namespace Aria::Internal {
    ...
    void Lexer::ParseIdentifier() {
        ...
        if (str == "new")      { AddToken(TokenKind::New,    SourceRange(start, SourceLocation(m_CurrentLine, GetColumn(m_Index))), "new");    return; }
        if (str == "delete")   { AddToken(TokenKind::Delete, SourceRange(start, SourceLocation(m_CurrentLine, GetColumn(m_Index))), "delete"); return; }
