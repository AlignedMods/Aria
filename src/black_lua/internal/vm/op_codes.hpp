...
namespace BlackLua::Internal {
    ...
    struct StackSlotIndex {
        ...
        StackSlotIndex(i32 slot) : Slot(slot) {}
        StackSlotIndex(i32 slot, size_t offset, size_t size) : Slot(slot), Offset(offset), Size(size) {}

        StackSlotIndex operator-(i32 lhs) { return StackSlotIndex(Slot - lhs, Offset, Size); }
        bool operator==(i32 lhs) { return Slot == lhs; }
...
// NOTE: These were generated by macros and then inlined
    ...
    struct OpCode {
        ...
        std::variant<StackSlotIndex, std::string, OpCodePush, OpCodeCopy, OpCodeOffset, OpCodeLoad, OpCodeJump, OpCodeMath, OpCodeCast> Data;
